...
class WorkoutDetailsModal extends StatefulWidget {
  static const routeName = './workout_details';
  final Workout? workout;
  const WorkoutDetailsModal({super.key, this.workout});

  @override
  State<WorkoutDetailsModal> createState() => _WorkoutDetailsModalState();
}

class _WorkoutDetailsModalState extends State<WorkoutDetailsModal> {
  XFile? _imageFile;
              ...
              children: [
                ...
                Container(
                    ...
                    height: widget.workout?.workoutsMedia != null
                        ? min(
                            (widget.workout!.workoutsMedia!.length / 3) * 30.h,
                            40.h)
                        : 0,
                    decoration:
                      ...
                      children: [
                        if (widget.workout?.workoutsMedia != null)
                          ...widget.workout!.workoutsMedia!.map((e) {
                            const startIndex = 0;
                            final endIndex = e.indexOf('?GoogleAccessId', 0);

                            var url = e.substring(
                                startIndex + 0, endIndex); // brown fox jumps
